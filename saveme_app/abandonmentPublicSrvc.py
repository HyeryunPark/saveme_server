...
def abandonedPetsParsing():
    ...
    url = "http://openapi.animal.go.kr/openapi/service/rest/abandonmentPublicSrvc/abandonmentPublic?serviceKey={}".format(ServiceKey)+"&bgnde=20200101&endde=20200416&numOfRows=5000"
